...
namespace Academy_test_task_1
{
    class Functional
    {
        ...
        List<Teacher> standart_teachers = new List<Teacher>()
            {
                 ...
                 new Teacher("Олег", "Піцун", "21.04.1991", Gender.Male, 1, 4, new List<string>() {"subject1", "subject2" } ),
                 new Teacher("Богдан", "Маслияк", "15.07.1960", Gender.Another, 3, 14, new List<string>() {"subject3", "subject4" } ),
                 new Teacher("Юрій", "Батько", "10.10.1980", Gender.Male, 2, 10, new List<string>() {"subject5", "subject6" } ),
                 new Teacher("Ігор", "Якименко", "11.12.1970", Gender.Male, 4, 13, new List<string>() {"subject7", "subject8" } )
            };
        ...
        List<Student> standart_students = new List<Student>
        {
            ...
            new Student ("Віталій", "Кухарук", "25.08.1998", Gender.Male , 3, 3, 4, 60),
            ...
            new Student ("Юрій", "Радовець", "29.02.1997", Gender.Another , 8, 8, 4, 100),
